...
/**
 * Listens for input in the mile field and updates the other fields.
 *
 * @author Footeware.ca
 */
public class MiListener implements ModifyListener {
	 ...
	 */
	public MiListener(LengthPanel lengthPanel) {
